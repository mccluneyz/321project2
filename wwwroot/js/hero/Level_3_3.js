...
export class Level_3_3 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_3_3" })
  }
  ...
  createTilemap() {
    this.map = this.make.tilemap({ key: "level_3_3" })
  ...
  createDecorations() {
    ...
    const decorPositions = [
      { x: 5 * 64, y: 11 * 64, variant: 2 },
      { x: 10 * 64, y: 9 * 64, variant: 3 },
      { x: 16 * 64, y: 7 * 64, variant: 4 },
      { x: 22 * 64, y: 9 * 64, variant: 5 },
      { x: 28 * 64, y: 11 * 64, variant: 6 },
      { x: 36 * 64, y: 13 * 64, variant: 7 }
    ]
  ...
  createEnemies() {
    ...
    const enemyPositions = [
      { x: 7 * 64, y: 11 * 64, patrol: 192 },
      { x: 12 * 64, y: 9 * 64, patrol: 128 },
      { x: 18 * 64, y: 7 * 64, patrol: 128 },
      { x: 24 * 64, y: 9 * 64, patrol: 128 },
      { x: 30 * 64, y: 11 * 64, patrol: 192 },
