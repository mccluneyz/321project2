...
export class Level_1_2 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_1_2" })
  }
  ...
  createEnemies() {
    ...
    // Spawn positions based on platform tops from tilemap
    // Start platform (row 12), Platform 1 (row 10), Platform 2 (row 8), Platform 3 (row 10), End platform (row 12)
    const enemyPositions = [
      { x: 5 * 64, y: 12 * 64, patrol: 160 },   // Start platform
      { x: 15 * 64, y: 10 * 64, patrol: 128 },  // Platform 1
      { x: 23 * 64, y: 8 * 64, patrol: 128 },   // Platform 2
      { x: 31 * 64, y: 10 * 64, patrol: 128 },  // Platform 3
      { x: 40 * 64, y: 12 * 64, patrol: 128 }   // End platform
    ]
