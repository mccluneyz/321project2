...
export class Level_3_4 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_3_4" })
  }
  ...
  createTilemap() {
    this.map = this.make.tilemap({ key: "level_3_4" })
  ...
  createDecorations() {
    ...
    const decorPositions = [
      { x: 4 * 64, y: 9 * 64, variant: 3 },
      { x: 9 * 64, y: 7 * 64, variant: 4 },
      { x: 14 * 64, y: 5 * 64, variant: 5 },
      { x: 20 * 64, y: 7 * 64, variant: 6 },
      { x: 26 * 64, y: 9 * 64, variant: 7 },
      { x: 32 * 64, y: 11 * 64, variant: 8 },
      { x: 37 * 64, y: 13 * 64, variant: 9 }
    ]
  ...
  createEnemies() {
    ...
    const enemyPositions = [
      { x: 6 * 64, y: 9 * 64, patrol: 192 },
      { x: 11 * 64, y: 7 * 64, patrol: 128 },
      { x: 16 * 64, y: 5 * 64, patrol: 128 },
      { x: 22 * 64, y: 7 * 64, patrol: 128 },
      { x: 28 * 64, y: 9 * 64, patrol: 192 },
      { x: 34 * 64, y: 11 * 64, patrol: 128 },
      { x: 38 * 64, y: 13 * 64, patrol: 128 }
    ]
