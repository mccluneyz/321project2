...
export class Level_1_4 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_1_4" })
  }
  ...
  createTilemap() {
    this.map = this.make.tilemap({ key: "level_1_4" })
  ...
  createEnemies() {
    ...
    // Based on actual tilemap: width 55, height 15
    // Base floor at row 14, platforms properly positioned
    const enemyPositions = [
      { x: 3 * 64, y: 12 * 64, patrol: 128 },   // Start platform (rows 12-13)
      { x: 11 * 64, y: 10 * 64, patrol: 128 },  // Platform 1 (rows 10-11)
      { x: 18 * 64, y: 8 * 64, patrol: 128 },   // Platform 2 (rows 8-9)
      { x: 25 * 64, y: 6 * 64, patrol: 128 },   // Platform 3 (rows 6-7)
      { x: 32 * 64, y: 8 * 64, patrol: 128 },   // Platform 4 (rows 8-9)
      { x: 39 * 64, y: 10 * 64, patrol: 128 },  // Platform 5 (rows 10-11)
      { x: 10 * 64, y: 14 * 64, patrol: 192 },  // Base floor
      { x: 27 * 64, y: 14 * 64, patrol: 192 },  // Base floor
      { x: 47 * 64, y: 12 * 64, patrol: 128 }   // End platform (rows 12-13)
    ]
