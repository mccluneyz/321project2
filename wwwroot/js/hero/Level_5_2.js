...
export class Level_5_2 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_5_2" })
  }
  ...
  create() {
    ...
    this.createTilemap()
    this.createPlayer()
    // this.createDecorations() // Disabled - wasteland_debris assets not loaded
    this.createEnemies()
  ...
  createTilemap() {
    // Use level_1_2 layout for level_5_2 with wasteland tiles
