...
export class Level_3_1 extends Phaser.Scene {
  ...
  createTilemap() {
    this.map = this.make.tilemap({ key: "level_3_1" })
  ...
  createDecorations() {
    ...
    const decorPositions = [
      ...
      { x: 7 * 64, y: 13 * 64, variant: 1 },
      { x: 15 * 64, y: 11 * 64, variant: 2 },
      { x: 23 * 64, y: 9 * 64, variant: 3 },
      { x: 32 * 64, y: 13 * 64, variant: 4 },
      { x: 36 * 64, y: 13 * 64, variant: 5 }
    ]
  ...
  createEnemies() {
    ...
    // Based on tilemap: Start (row 13), Platform 1 (row 11), Platform 2 (row 9), End (row 13)
    const enemyPositions = [
      { x: 5 * 64, y: 13 * 64, patrol: 192 },   // Start platform
      { x: 16 * 64, y: 11 * 64, patrol: 128 },  // Platform 1
      { x: 24 * 64, y: 9 * 64, patrol: 128 },   // Platform 2
      { x: 34 * 64, y: 13 * 64, patrol: 256 }   // End platform
    ]
