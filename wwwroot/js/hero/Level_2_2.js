...
export class Level_2_2 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_2_2" })
  }
  ...
  createTilemap() {
    this.map = this.make.tilemap({ key: "level_2_2" })
  ...
  createEnemies() {
    ...
    // Based on tilemap: Start (row 12), Platform 1 (row 10), Platform 2 (row 8), Platform 3 (row 10), End (row 12)
    const enemyPositions = [
      { x: 4 * 64, y: 12 * 64, patrol: 160 },   // Start platform
      { x: 14 * 64, y: 10 * 64, patrol: 128 },  // Platform 1
      { x: 22 * 64, y: 8 * 64, patrol: 128 },   // Platform 2
      { x: 30 * 64, y: 10 * 64, patrol: 128 },  // Platform 3
      { x: 40 * 64, y: 12 * 64, patrol: 192 }   // End platform
    ]
