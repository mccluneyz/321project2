// Copy of 4-3 with level_4_4 key
...
export class Level_4_4 extends Phaser.Scene {
  constructor() {
    super({ key: "Level_4_4" })
  }
  ...
  createTilemap() {
    // Use level_1_4 layout for level_4_4 with ocean tiles
  ...
  createEnemies() {
    ...
    const enemyPositions = [
      ...
      { x: 15 * 64, y: 12 * 64, patrol: 150 },
      { x: 32 * 64, y: 11 * 64, patrol: 160 },
      { x: 26 * 64, y: 10 * 64, patrol: 140 }
    ]
